...
\begin{rem}
    \begin{enumerate}
        \item Despite the name, the definition of horizontal forms does not depend on any choice of the horizontal distribution. For this reason, horizontal forms are also often called \emph{semibasic}.\index{Semibasic form}
...
\begin{proof}
    ...
    (2) and (3) were proven in Proposition~\ref{prop 1.5.2 Cap 2-3}.
\end{proof}
