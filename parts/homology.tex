...
\begin{defn}[Euler characteristic]\index{Euler characteristic}
    ...
    The numbers $\beta_k=\rank \rmH_k(\bm{C})$ are called Betti numbers.\index{Betti numbers}
...
\section{Homological Algebra IV: Applications \texorpdfstring{\ucmark}{}}
...
\clearpage
\section{Cohomology of Topological Spaces \texorpdfstring{\ucmark}{}}
...
\subsection{\texorpdfstring{$\rmH_1$}{H1} and \texorpdfstring{$\rmH^1$}{H1}}
...
\section{Applications \texorpdfstring{\ucmark}{}}
