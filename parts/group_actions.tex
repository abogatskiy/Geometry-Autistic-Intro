...
\begin{rem}
    ...
    \[\boxed{(P\times_M \underline{h}^\ast P')\times^{G\times G'}\calS(F,F')\to M,}\] 
    ...
    (assuming $\calS(F,F')$ and $\scrO_f$ carry sufficiently nice topologies). These sets are usually very different from the sets of morphisms between $P$ and $P'$. 
