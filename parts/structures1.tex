...
\begin{example}[Equivalence of differential forms]
...
% \[0\to g_r\overset{\partial_{r,0}}{\to}g_{r-1}\otimes V^\ast\overset{\partial_{r-1,1}}{\to}g_{r-2}\otimes \bigwedge^2 V^\ast \overset{\partial_{r-2,2}}{\to}0,\]
% where the operators $\partial_{r,q}:g_r\otimes\bigwedge^q V^\ast\to g_{r-1}\otimes \bigwedge^{q+1}V^\ast$ are defined in the following way: any element $\xi\in g_r\otimes \bigwedge^q V^\ast$ can be considered as an exterior $g_r$-valued $q$-form on $V$, and then 
...
% Now let $P<\Fr^r(\T M)$ be a $G$-structure of order $r$ and let $\frakg<L^0\slash L^r$ be the Lie algebra of $G$. By definition,
